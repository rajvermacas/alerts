"""System prompts for the Insider Trading Analyzer agent.

This module contains the main system prompt and supporting prompts
that guide the agent's reasoning and decision-making for insider
...
from alerts.models.base import FewShotExamplesCollection
...
def get_system_prompt(few_shot_examples: Optional[str] = None) -> str:
    """Get the main system prompt for the insider trading agent.
