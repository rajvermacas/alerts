...
1. Legacy pattern: __call__() with _load_data() for file-based loading
2. Proactive pattern: execute() with data injection for Big Data Layer integration
...
class BaseTool(ABC):
    ...
    Supports two execution patterns:
    1. Legacy: __call__() with _load_data() - for file-based data loading
    2. Proactive: execute() - for injected data from Big Data Layer
